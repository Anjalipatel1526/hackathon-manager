...
function handleRequest(payload) {
    ...
    function handleMockSubmission(phase) {
        ...
        if (phase === 1) {
             ...
             const subject = "Phase 1 Submission Received - Codekar Hackathon";
